					...
					{!! Form::open(array('route' => 'companiessaved', 'method' => 'post')) !!}
						...
						<div id="divcompany">
							<div class="col-xs-12 col-sm-6 col-md-6" style="padding: unset;padding-right: 10px;">
								...
								<label>Company</label>
								<input name="CompanyName" placeholder="Company Name" type="text" class="form-control-madeself" style="margin-bottom:20px"/>
								<label>Company Website</label>
								<input name="CompanyWebsite" placeholder="Company Website" type="text" class="form-control-madeself" style="margin-bottom:20px"/>			
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6" style="padding: unset;padding-left: 10px;">
								<label>Company Phone Number</label>
								<input name="CompanyPhoneNumber" placeholder="Company Phone Number" type="text" class="form-control-madeself" style="margin-bottom:20px"/>
								<label>Company Address</label>
								<textarea name="CompanyAddress" placeholder="Company Address" type="text" class="form-control-madeself" style="margin-bottom:20px;height:155px"></textarea>
							</div>
						</div>
